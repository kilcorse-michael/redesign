...
export default function TechSlide() {
  ...
  return (
    <div className="flex flex-col md:flex-row items-center justify-center h-screen">
      <div
        className={` flex items-center justify-center text-center w-full h-full transition-colors duration-500 ${
          ScrollDirection() === "down" ? "bg-[#ff0178]" : "bg-[#c2005b]"
        }`}
      >
        <div className="w-3/4">
          <p className="md:m-10 content-center font-semibold text-5xl lg:text-7xl text-white">
            ...
            deliver a <span className="text-[#01008e]">clean</span> and{" "}
            <span className="text-[#01008e]">modern</span> user experience.
          </p>
          {isMobile() ? (
