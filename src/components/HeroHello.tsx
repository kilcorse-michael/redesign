...
export default function HeroHello() {
    ...
    return(
        <>
        <div className='flex justify-center items-center h-[95vh] bg-[#00003f] '>
            ...
            <div className="h-screen ml-8 w-screen">
                ...
                <Parallax speed={15}>
                    <h1 className="text-[#9001f5] text-8xl nd:text-9xl m-l-1">Hello,</h1>
                    <h2 className="text-[#9001f5] flex-row text-6xl md:text-8xl m-l-1">my name is</h2>
                    <h1 className="text-white flex-row text-7xl md:text-9xl m-l-1">Michael Kilcorse</h1>
                    <h3 className="text-[#9001f5] ml-48 flex-row text-4xl md:text-5xl m-l-1">[maɪ/kəl/]  -  [kɪl kɔrs]</h3>
                    </Parallax>
                </div>
                <div className="absolute right-1/4 -top-40 loader">
                <Parallax speed={7}>
